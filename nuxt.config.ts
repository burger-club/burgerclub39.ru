  ...
  app: {
    head: {
      ...
      meta: [
        ...
        {
          name: 'keywords',
          content: 'заказать бургер в Советске/Гусеве, хотдог, бурегр, доставка, Калининградская область бургерная, покушать Калининград, выберите, добавить, самые, бургеры',
        },
